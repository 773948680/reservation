  ...
  return (
    <div className="max-w-[400px] w-full bg-white p-6 rounded-md shadow-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <div className="mb-4">
          ...
          <input type="text" id="firstName" {...register('firstName', { required: 'Ce champ est requis' , pattern: {
    ...
    message: 'Veuillez entrer un prénom valide (lettres uniquement)',
        ...
        <div className="mb-4">
          ...
          <input type="text" id="lastName" {...register('lastName', { required: 'Ce champ est requis',  pattern: {
    value: /^[A-Za-zÀ-ÖØ-öø-ÿ\s]+$/,
    message: 'Veuillez entrer un nom valide (lettres uniquement)',
        ...
        <div className="mb-4">
          ...
          <input type="tel" id="phone" {...register('phone', { required: 'Ce champ est requis', pattern: { value: /^\d{09}$/, message: 'Numéro de téléphone invalide' } })} className="outline-none form-input mt-1 block w-full border-b border-b-gray-300" />
